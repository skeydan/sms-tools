...
def selectFlatPhasePeak(pX, p, phaseDevThres):
    ...
    """
    test = pX[int(p - 2):int(p + 2)]
    sd = np.std(test)
    ret = True if sd < phaseDevThres else False
    print(test, sd, ret)
    return(ret)
...
#
# selectFlatPhasePeak(
#     np.array([1.0, 1.2, 1.3, 1.4, 0.9, 0.8, 0.7, 0.6, 0.7, 0.8]),
#     p = 3,
#     phaseDevThres = 0.25
# )
#
...
#
# selectFlatPhasePeak(
#     np.array([2.39, 2.40, 2.40, 2.41, 3.37, 2.45, 2.46, 2.46, 2.29, 1.85, 2.34,
# 2.18, 2.93, 2.10, 3.39, 2.41, 2.41, 2.40, 2.40, 2.40, 1.46, 0.23, 0.98, 0.41, 0.37, 0.40, 0.41,
# 0.87, 0.51, 0.67]),
#     p = 17,
#     phaseDevThres = 0.01
